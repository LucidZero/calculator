...
let inputField = document.querySelector("#currentInput");
...
/* on operator class click sum currentInput up with previousInput and set is as previousInput
on del(backspaceButton) click pop last member of array
 */
